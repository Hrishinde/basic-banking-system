...
<head>
    ...
    define('bankName', 'Sparks Bank',true);
...
<body style="background: url(https://www.indiafilings.com/learn/wp-content/uploads/2015/10/Bank-guarantee-in-India.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Hrishikesh Shinde</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
